...
export const getArticlePageLimit = (state: StateSchema) => state.articlesPage?.limit || 10;
export const getArticlePageHasMore = (state: StateSchema) => state.articlesPage?.hasMore;
export const getArticlePageInited = (state: StateSchema) => state.articlesPage?.inited;

export const getArticlePageOrder = (state: StateSchema) => state.articlesPage?.order || SortOrder.ASC;
...
export const getArticlePageSelectedTypes = (state: StateSchema) => state.articlesPage?.type || [ArticleType.ALL];